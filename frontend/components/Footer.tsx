        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          >
            <h3 className="text-2xl font-bold mb-4">
              <span className="text-primary">Lasso Sin Límites</span>
            </h3>
            <p className="text-background/70 max-w-sm text-justify">
              Lasso Sin Límites es la opción ideal para empresas de todos los
              tamaños que buscan implementar las últimas tecnologías en sus
              negocios.
            </p>
            <div className="flex gap-4 mt-6">
              {(["youtube", "linkedin", "instagram", "facebook"] as const).map(
                (social) => {
